...
public class V3FaceRecActivity extends FaceBaseActivity implements BaseFaceRecProcessor.FaceRecCallback, FingerDevStatusConnectListener, CardInfoListener {

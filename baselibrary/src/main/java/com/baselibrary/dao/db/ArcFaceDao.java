...
/** 
 * DAO for table "ARC_FACE".
*/
public class ArcFaceDao extends AbstractDao<ArcFace, Long> {

    public static final String TABLENAME = "ARC_FACE";

    /**
     * Properties of entity ArcFace.<br/>
    ...
    public ArcFaceDao(DaoConfig config) {
        super(config);
    }
    
    public ArcFaceDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ARC_FACE\"";
        db.execSQL(sql);
    }

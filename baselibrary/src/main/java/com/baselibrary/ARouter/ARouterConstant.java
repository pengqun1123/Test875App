...
public class ARouterConstant {
    ...
    //Group
    public static final String GROUP_FINGER = "finger";
    public static final String GROUP_PW = "pw";

    /*  Url  */

    //Finger
    public static final String FINGER_ACTIVITY = "/finger/finger_act";

    //Pw
    public static final String PW_ACTIVITY = "/pw/pw_act";
